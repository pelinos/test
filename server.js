...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'hi') {
		if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
			msg.reply('**Hello, Welcome to this server!**'); 
		} else {
		msg.reply('**Hello, Welcome to this server!**');
		}
	}
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'hello') {
		if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
			msg.reply('**Hi, Welcome to this server!**'); 
		} else {
		msg.reply('**Hi, Welcome to this server!**');
		}
	}
...
client.on('guildMemberAdd', member => {
  ...
  const channel = member.guild.channels.find('「🚪」gelen-giden' , '#「🚪」gelen-giden' , '#「🚪」gelen-giden ' , ' 「🚪」gelen-giden');
  if (!channel) return;
